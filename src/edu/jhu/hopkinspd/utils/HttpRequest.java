...
public final class HttpRequest {
     ...
     */
    public void send(URL url, edu.jhu.hopkinspd.utils.CrashReportSender.Method mMethod, String content, edu.jhu.hopkinspd.utils.CrashReportSender.Type mType) throws IOException {

        final HttpClient httpClient = getHttpClient();
        final HttpEntityEnclosingRequestBase httpRequest = getHttpRequest(url, mMethod, content, mType);

        ACRA.log.d(ACRA.LOG_TAG, "Sending request to " + url);
        if (ACRA.DEV_LOGGING)
            ACRA.log.d(ACRA.LOG_TAG, "Http " + mMethod.name() + " content : ");
        if (ACRA.DEV_LOGGING)
    ...
    private HttpEntityEnclosingRequestBase getHttpRequest(URL url, edu.jhu.hopkinspd.utils.CrashReportSender.Method mMethod, String content, edu.jhu.hopkinspd.utils.CrashReportSender.Type mType)
        ...
        httpRequest.setHeader("Content-Type", mType.getContentType());
